                        ...
                        <Grid item xs={6}>
                            <div style={{ padding: "0 30px", background: "#ccc" }}>
                                <Slider className="mainSlider" asNavFor={nav2} ref={slider1}>
                                    <div >
                                        <img src={anh.image1} alt="" className="dialog__image imageview" />
                                    </div>
                                    <div >
                                        <img src={anh.image2} alt="" className="dialog__image imageview" />
                                    </div>
                                    <div >
                                        <img src={anh.image3} alt="" className="dialog__image imageview" />
                                    </div>
                                </Slider>
                                <Slider
                                    asNavFor={nav1}
                                ...
                                >
                                    <div >
                                        <img src={anh.image1} alt="" className="dialog__image" />
                                    </div>
                                    <div >
                                        <img src={anh.image2} alt="" className="dialog__image" />
                                    </div>
                                    <div >
                                        <img src={anh.image3} alt="" className="dialog__image" />
                                    </div>
                                    <div >
                                        <img src={anh.image3} alt="" className="dialog__image" />
                                    </div>
